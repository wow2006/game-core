#ifndef GC_PATHINTERPOL_H
#define GC_PATHINTERPOL_H
#pragma once
...
namespace gcore
{
	...
	*/
	template < typename StateType, typename PathType, typename SpaceUnitType = float , class RelationType = float >
	class PathInterpol : virtual public Interpolator< StateType >
	{
	public:
